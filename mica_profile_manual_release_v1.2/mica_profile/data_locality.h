...
class DataLocality {
	...
	int *stLocaltemp;
	int *stLocalspac;*/
	int *ldGlobaltemp = new int[D_DIST_SIZE];	//[pz:new]
	int *ldGlobalspac = new int[D_DIST_SIZE];
	int *ldLocaltemp = new int[D_DIST_SIZE];
	int *ldLocalspac = new int[D_DIST_SIZE];
	int *stGlobaltemp = new int[D_DIST_SIZE];
	int *stGlobalspac = new int[D_DIST_SIZE];
	int *stLocaltemp = new int[D_DIST_SIZE];
	int *stLocalspac = new int[D_DIST_SIZE];
